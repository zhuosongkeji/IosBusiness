...
- (void)setupSegmen
{
    ...
    ADRTCarryMoneyDetailVC *vc1 = [[ADRTCarryMoneyDetailVC alloc] init];
    
    ADRTBalanceDetailVC *vc2 = [[ADRTBalanceDetailVC alloc] init];
