...
@interface ADStatisticsViewTwo () <ZFGenericChartDataSource, ZFBarChartDelegate>
...
@implementation ADStatisticsViewTwo
...
- (void)setupBarchart
{
    self.barChart = [[ZFBarChart alloc] initWithFrame:CGRectMake(0, 20, SCREEN_WIDTH , 200)];
        ...
        self.barChart.topicLabel.text = @"销售额统计";
